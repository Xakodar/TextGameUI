...
public class Game
{
    ...
    public Game()
    {
        ...
        {   
            ...
            {
                Id = 18,
                Text = " Подойдя ближе, Таулусаня смог рассмотреть мальца поподробне. У ребенка были зеленые глаза и красные волосы, он был одет в лахмотья, а в руках держал стопку газет.",
                Variants = new List<Variant>
                {
                    new Variant
                    {
